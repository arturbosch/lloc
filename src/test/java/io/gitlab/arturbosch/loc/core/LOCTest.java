...
public class LOCTest {
	...
	private static final int EXPECTED_LOC_WITH_COMMENTS_AND_IMPORTS_ETC = 19;

	private static File file = new File("./src/main/java/io/gitlab/arturbosch/loc/exceptions/UnsupportedLanguageException.java");
	private static File file2 = new File("./src/main/java/io/gitlab/arturbosch/loc/exceptions/ToFewArgumentsException.java");
